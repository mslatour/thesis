...
\begin{table}[h!]
	...
	\begin{tabular}{llllll}\hline
		...
		\texttt{pop5ep5} & 5 & 5 & 2 & 0.05 \\ %pop5ep5 = george
		\texttt{pop5ep10} & 5 & 10 & 2 & 0.05 \\ %pop5ep10 = david
		\texttt{pop5ep20} & 5 & 20 & 2 & 0.05 \\ %pop5ep20 = stephen
		\texttt{pop10ep10} & 10 & 10 & 2 & 0.05 \\ %pop10ep10 = erik
		\texttt{pop10ep20} & 10 & 20 & 2 & 0.05 \\ %pop10ep20 = xavier
		\texttt{pop20ep20} & 20 & 20 & 2 & 0.05 \\\hdashline %pop20ep20 = peter
		% Dutch SIG OER members
		\texttt{el0mu05} & 10 & 10 & 0 & 0.05 \\ %el0mu05 = robert
		\texttt{el1mu05} & 10 & 10 & 1 & 0.05 \\ %el1mu05 = martijn
		\texttt{el2mu05} & 10 & 10 & 2 & 0.05 \\ %el2mu05 = ria
		\texttt{el0mu25} & 10 & 10 & 0 & 0.25 \\ %el0mu25 = ellen
		\texttt{el1mu25} & 10 & 10 & 1 & 0.25 \\ %el1mu25 = nicolai
		\texttt{el2mu25} & 10 & 10 & 2 & 0.25 \\ %el2mu25 = saskia
	\end{tabular}
\end{table}\\
\noindent
...
amount of episodes as the \texttt{pop5ep20} setup but a higher number of
...
\begin{figure}[ht]
	...
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_cumul_joined_david_erik_stephen_xavier_peter_george_handcrafted_nobars_systematic.png}
	\caption{overview}
...
%	\end{subfigure}
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_cumul_joined_david_erik_stephen_xavier_peter_george_handcrafted_noise_nobars_systematic.png}
	\caption{overview}
...
\begin{figure}[ht]
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_cover_joined_david_erik_stephen_xavier_peter_george_handcrafted_nobars_systematic.png}
	\caption{overview}
...
longer present in the generation. The counterpart of \texttt{el0mu05} with a high
...
\begin{figure}[ht]
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_cumul_joined_robert_saskia_ellen_martijn_nicolai_ria_handcrafted_nobars_systematic.png}
	\caption{overview}
...
\begin{figure}[ht]
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_cumul_joined_robert_saskia_ellen_martijn_nicolai_ria_handcrafted_noise_nobars_systematic.png}
	\caption{overview}
...
\begin{figure}[ht]
	\begin{subfigure}{0.48\linewidth}
	% origin: simulation_2014-05-28-1432
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_conv_joined_david_erik_stephen_xavier_peter_george_handcrafted_systematic.png}
	...
	\begin{subfigure}{0.48\linewidth}
	% origin: simulation_2014-05-28-2308
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_conv_joined_david_erik_stephen_xavier_peter_george_handcrafted_noise_systematic.png}
	\caption{Group 1 parameter setups, with noise}
	\label{fig:conv_group1_handcrafted_noise}
	\end{subfigure}
	\begin{subfigure}{0.48\linewidth}
	% origin: simulation_2014-05-28-1622
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_conv_joined_robert_saskia_ellen_martijn_nicolai_ria_handcrafted_systematic.png}
	...
	\begin{subfigure}{0.48\linewidth}
	% origin: simulation_2014-05-28-2118
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_conv_joined_robert_saskia_ellen_martijn_nicolai_ria_handcrafted_noise_systematic.png}
...
\begin{figure}[ht]
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_cover_joined_robert_saskia_ellen_martijn_nicolai_ria_handcrafted_nobars_systematic.png}
	\caption{overview}
...
\begin{figure}[ht]
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_cover_joined_david_erik_stephen_xavier_peter_george_handcrafted_noise_nobars_systematic.png}
	\caption{overview}
...
\begin{figure}[ht]
	...
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\includegraphics[width=\linewidth]{images/results/revised/plot_sim_cover_joined_robert_saskia_ellen_martijn_nicolai_ria_handcrafted_noise_nobars_systematic.png}
	\caption{overview}
