...
% Chapter: Results %
%%%%%%%%%%%%%%%%%%%%
The experiment described in Section~\ref{ch:experimental_setup} offers an
...
experiment is to answer the central question: does the system learn to pick sequences
...
\noindent
The participants that made it to the end of the experiment also completed the
final exam, where they played five consecutive Nim games.
Table~\ref{tab:results_exam} shows the frequency of exam scores for the first,
second, third and last 25\% of those participants. The average score is
slightly higher in the last 25\% compared to the first. However, there is not a
clear trend upwards. The experiment has thus not convincingly shown a clear
improvement in participants' understanding of how to play the Nim game. In
other words, the sequences presented in each lesson did not improve over time
enough to cause a clear effect on the displayed Nim competence.\\\\
\noindent
The answer to the central question is, yes in some populations it did. It is not known
...
sequences evaluated at least once.}
	...
	\begin{tabular}{llllll}\hline
		Population & Convergence & Best &
		First 20\% & Last 20\% & Coverage \\\hline
...
\begin{table}
	...
	\label{tab:results_exam}
	\begin{tabular}{l|lllllll}\hline
		\multicolumn{1}{l}{} & \multicolumn{6}{c}{Frequency of number of games won} & \\
		\multicolumn{1}{l}{Participants} & 0 wins & 1 win & 2 wins & 3 wins & 4
		wins & 5 wins & Average win\\\hline
...
\begin{figure}[ht]
	...
	\includegraphics[width=0.9\linewidth]{images/results/revised/plot_exp_cumul_nimsum_low.png}
	\caption{Nim-sum low}
	\label{fig:exp_cumul_nimsum_low}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.45\linewidth}
	\includegraphics[width=0.9\linewidth]{images/results/revised/plot_exp_cumul_nimsum_high.png}
